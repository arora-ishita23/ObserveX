    ...
    <footer ref={footerRef} className="scroll-animate py-16 px-4 border-t border-purple-400/20">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl font-bold font-orbitron text-white">ObserveX</h3>
            </div>
            <p className="text-gray-400 font-rajdhani">
              Advanced AI-powered security detection and analysis system for the future of space exploration.
            </p>
          </div>
        ...
        <div className="border-t border-purple-400/20 pt-8 text-center">
          <p className="text-gray-400 font-rajdhani">© 2025 ObserveX AI Detection System. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
